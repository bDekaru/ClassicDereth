...
public:
	...
	DWORD type; // 0x1C / 0x28
	SurfaceHandlerEnum handler; // 0x20 / 0x2C
	DWORD color_value; // 0x24 / 0x30
	DWORD solid_index; // 0x28 / 0x34
	DWORD indexed_texture_id; // 0x2C / 0x38
	...
	DWORD orig_texture_id; // 0x44 / 0x50
	DWORD orig_palette_id; // 0x48 / 0x54
